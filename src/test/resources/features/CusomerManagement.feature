...
Feature: Customer Management
  ...
  @NewCustomerBasicInfoField @SomkTast
  ...
  @newCustomerCreatedMessage @SomkTast
  ...
  @newCustomerCreatedMessageFieldIsRequired @SomkTast
  ...
  @newCustomerFormErrorMessages @SomkTast
